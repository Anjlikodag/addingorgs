...
public final class AssetTransferTest {
    ...
    class InvokeWriteTransaction {
        ...
        public void createAssetWhenNewAssetIsCreated() throws CertificateException, IOException {
            ...
            when(ci.getId()).thenReturn(testAppleClient);
        ...
        public void transferAssetWhenExistingAssetIsTransferred() throws CertificateException, IOException {
            ...
            when(ctx.getClientIdentity()).thenReturn(ci);
            when(ci.getMSPID()).thenReturn(testOrgOneMSP);
            final String recipientOrgMsp = "TestFiserv";
            final String buyerIdentity = "TestFiservUser";
            Map<String, byte[]> m = new HashMap<String, byte[]>();
    ...
    private static String testOrgOneMSP = "TestApple";
    private static String testAppleClient = "testAppleUser";

    private static String testAsset1ID = "asset1";
    private static Asset testAsset1 = new Asset("testasset", "asset1", "blue", 5, testAppleClient);
    private static byte[] dataAsset1Bytes = "{ \"objectType\": \"testasset\", \"assetID\": \"asset1\", \"color\": \"blue\", \"size\": 5, \"owner\": \"testAppleUser\", \"appraisedValue\": 300 }".getBytes();
