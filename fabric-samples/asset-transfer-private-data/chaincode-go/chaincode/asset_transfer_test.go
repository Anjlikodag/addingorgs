...
const myAppleMsp = "AppleTestmsp"
const myAppleClientid = "myAppleUserid"
const myApplePrivCollection = "AppleTestmspPrivateCollection"
const myFiservMsp = "FiservTestmsp"
const myFiservClientid = "myFiservUserid"
const myFiservPrivCollection = "FiservTestmspPrivateCollection"
...
func TestCreateAssetSuccessful(t *testing.T) {
	...
	require.Equal(t, myApplePrivCollection, calledCollection)
	require.Equal(t, "id1", calledId)
...
func TestAgreeToTransferSuccessful(t *testing.T) {
	...
	require.Equal(t, []byte(myAppleClientid), calledWithDataBytes)
}
...
func TestTransferAssetSuccessful(t *testing.T) {
	...
	//to ensure that ReadTransferAgreement call returns fiserv client ID
	chaincodeStub.GetPrivateDataReturnsOnCall(1, []byte(myFiservClientid), nil)
	chaincodeStub.CreateCompositeKeyReturns(transferAgreementObjectType+"id1", nil)
	...
	expectedNewAsset.Owner = myFiservClientid
...
func TestTransferAssetByNonOwner(t *testing.T) {
	...
	setReturnAssetOwnerInTransientMap(t, chaincodeStub, assetNewOwner)
	//Try to transfer asset owned by Fiserv
	fiservAsset := chaincode.Asset{
		ID:    "id1",
		Type:  "testfulasset",
		Color: "gray",
		Size:  7,
		Owner: myFiservClientid,
	}
	setReturnPrivateDataInStub(t, chaincodeStub, &fiservAsset)
	err := assetTransferCC.TransferAsset(transactionContext)
...
func prepMocksAsApple() (*mocks.TransactionContext, *mocks.ChaincodeStub) {
	return prepMocks(myAppleMsp, myAppleClientid)
}
func prepMocksAsFiserv() (*mocks.TransactionContext, *mocks.ChaincodeStub) {
	return prepMocks(myFiservMsp, myFiservClientid)
}
