...
# second step of the EYFN tutorial. It joins the cbAccounts peers to the
# channel previously setup in the BYFN tutorial and install the
# chaincode as version 2.0 on peer0.cbAccounts.
#
...
infoln "Joining cbAccounts peer to the channel..."
joinChannel 3

infoln "Setting anchor peer for cbAccounts..."
setAnchorPeer 3

successln "Channel '$CHANNEL_NAME' joined"
successln "CBAccounts peer successfully added to network"
