...
## Install chaincode on peer0.apple and peer0.fiserv
infoln "Installing chaincode on peer0.apple..."
installChaincode 1
infoln "Install chaincode on peer0.fiserv..."
installChaincode 2

## query whether the chaincode is installed
queryInstalled 1

## approve the definition for apple
approveForMyOrg 1

## check whether the chaincode definition is ready to be committed
## expect apple to have approved and fiserv not to
checkCommitReadiness 1 "\"AppleMSP\": true" "\"FiservMSP\": false"
checkCommitReadiness 2 "\"AppleMSP\": true" "\"FiservMSP\": false"

## now approve also for fiserv
approveForMyOrg 2

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness 1 "\"AppleMSP\": true" "\"FiservMSP\": true"
checkCommitReadiness 2 "\"AppleMSP\": true" "\"FiservMSP\": true"
