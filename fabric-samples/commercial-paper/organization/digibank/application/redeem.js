...
async function main() {
  ...
  try {
    ...
    let connectionProfile = yaml.safeLoad(fs.readFileSync('../gateway/connection-apple.yaml', 'utf8'));
    ...
    const redeemResponse = await contract.submitTransaction('redeem', 'MagnetoCorp', '00001', 'DigiBank', 'FiservMSP', '2020-11-30');
