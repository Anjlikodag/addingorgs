...
infoln "Joining apple peer to the channel..."
joinChannel 1
infoln "Joining fiserv peer to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for apple..."
setAnchorPeer 1
infoln "Setting anchor peer for fiserv..."
setAnchorPeer 2
