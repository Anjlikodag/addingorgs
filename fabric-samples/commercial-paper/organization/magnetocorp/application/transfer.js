...
async function main() {
    ...
    try {
        ...
        let connectionProfile = yaml.safeLoad(fs.readFileSync('../gateway/connection-fiserv.yaml', 'utf8'));
        ...
        const transferResponse = await contract.submitTransaction('transfer', 'MagnetoCorp', '00001', 'DigiBank', 'AppleMSP', '2020-06-01');
